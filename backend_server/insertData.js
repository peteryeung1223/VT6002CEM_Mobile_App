...
const tasks = [
    {
        ...
        description: "Create a new GitHub repository for the project and set up the initial structure.",
        user: "Alice",
    ...
    {
        _id: "5GS1JYbdgoOvd21pWuZN",
        comments: [
            {
                user: "Charlie",
                title: "I'll generate the initial docs after the endpoints are defined.",
                id: "x1jbjkzz",
                createdAt: "2025-02-07T16:35:18.102+08:00",
            },
            {
                id: "725b2d54-9e13-46c8-a4ab-8a23562d0784",
                title: "Hi",
                user: "default_user",
                createdAt: "2025-05-14T02:21:27.980Z",
            },
        ],
        user: "Eve",
        title: "Create API documentation",
        createdAt: "2025-02-07T15:11:09.470+08:00",
        description: "Use Swagger to document all API endpoints.",
        commentCount: 2,
    },
    {
        _id: "HcqtIJs3lTpqHboMbdzc",
        title: "Set up CI/CD pipeline",
        user: "Frank",
        createdAt: "2025-02-07T15:10:27.222+08:00",
        comments: [],
        description: "Configure GitHub Actions for automated testing and deployment.",
        commentCount: 0,
    },
    {
        _id: "njhfT9JnAuPP0yoTHeps",
        comments: [
            {
                createdAt: "2025-02-07T17:08:05.317+08:00",
                user: "Alice",
                title: "Let's use Figma for collaboration.",
                id: "x3phezh7",
            },
            {
                id: "8511456b-f251-4635-bcad-2e96d85252f5",
                title: "Hi",
                user: "default_user",
                createdAt: "2025-05-14T01:51:37.093Z",
            },
        ],
        title: "Design UI mockups",
        user: "Grace",
        description: "Create wireframes and mockups for the main pages.",
        createdAt: "2025-02-07T15:10:22.857+08:00",
        commentCount: 2,
    },
];
...
const insertData = async () => {
    try {
        for (const task of tasks) {
            ...
            await setDoc(doc(collection(db, "tasks"), _id), taskData);
